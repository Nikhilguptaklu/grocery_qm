  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <Helmet>
        ...
        <meta property="og:url" content="https://hnmart.in/signup" />
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-muted-foreground">
            Join HN Mart and start shopping fresh groceries
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-center">
                Create your HN Mart account to get started
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="name" name="name" type="text" placeholder="Enter your full name"
                    value={formData.name} onChange={handleChange} className="pl-10" required />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="password" name="password" type={showPassword ? 'text' : 'password'}
                    ...
                    onChange={handleChange} className="pl-10 pr-10" required />
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="confirmPassword" name="confirmPassword"
                    ...
                    value={formData.confirmPassword} onChange={handleChange} className="pl-10 pr-10" required />
                  <Button type="button" variant="ghost" size="sm"
                    className="absolute right-0 top-0 h-full px-3 py-2 hover:bg-transparent"
              ...
              <div className="flex items-center space-x-2">
                <input id="terms" type="checkbox" className="w-4 h-4 text-primary border-border rounded focus:ring-ring" required />
